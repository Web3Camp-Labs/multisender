...
module.exports = {
  ...
  networks: {
    ...
    bsc: {
      provider: () => new HDWalletProvider(keys.kovan, `https://bsc-dataseed1.binance.org`),
    ...
    bsctest: {
      provider: () => new HDWalletProvider(keys.kovan, `https://data-seed-prebsc-1-s1.binance.org:8545`),
